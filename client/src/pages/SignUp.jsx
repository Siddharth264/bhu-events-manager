  ...
  return (
    <div className="max-w-lg mx-auto mt-32 bg-white border-slate-500 shadow-2xl p-10 rounded-lg">
      ...
      <form  onSubmit={handleSubmit} className="flex flex-col gap-3" >
        ...
        <input className="rounded-lg  p-2  focus: outline-none focus:ring-0  focus:border-2 focus:shadow-lg border-2 focus:border-gray-400" type="text" id="userName"  onChange={handleChange} /></div>
        <div className="flex flex-col gap-1"><span className="text-sm font-serif tracking-wider text-gray-600 font-medium">Email</span>
        <input className="rounded-lg border-neutral-300 p-2 focus: outline-none focus:ring-0   focus:border-2 focus:shadow-lg border-2 focus:border-gray-400"type="email" id="email" onChange={handleChange} /></div>
        ...
        <input className="rounded-lg border-neutral-300 p-2 focus: outline-none focus:ring-0  focus:border-2 focus:shadow-lg border-2 focus:border-gray-400" type="password" id="password"  onChange={handleChange}/></div>
