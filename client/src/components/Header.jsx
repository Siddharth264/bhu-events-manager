  ...
  return (
    <div className="flex flex-row shadow-lg max-w-full max-h-26  bg-gradient-to-r from-indigo-200 from-10% via-sky-400 via-30% to-emerald-300 to-90% ...">
      ...
      <div className="mr-0 ml-auto">
        ...
        <Link to={'/signup'}>
        <button className=" h-7 w-20 rounded-lg mr-16 mt-10 uppercase font-sans font-medium tracking-wide text-white text-sm outline outline-offset-2  outline-1 shadow-xl no-underline  ">
          Sign Up
        </button>
        </Link>
      </div>
